...
parser.add_argument("--save_path", type=str, default='./results/tor/session/lessdetail/pkts')
...
if __name__ == '__main__':
	...
	for i in range(1,6):
		with open('dataset/data_tor/session/lessdetail/session2pkts_50_2500/tor_pkt_50_2500_%d.pkl'%i, 'rb') as f:
