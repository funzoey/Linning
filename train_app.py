...
from tool_app_total import traffics_app,load_epoch_data,max_byte_len
...
parser.add_argument("--save_path", type=str, default='./results/app/session/lessdetail/chat_nontor_session2pkts_len_50_42_256')
...
if __name__ == '__main__':
	...
	for i in range(1):
		with open('./dataset/data_app_nonvpn/session/lessdetail/chat_nontor_pkt_50_500_%d.pkl'%i, 'rb') as f:
