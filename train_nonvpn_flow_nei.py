...
from Transformer import Transformer_pkt,classification
...
parser.add_argument("--save_path", type=str, default='./results/nonvpn/session/lessdetail/session2flows_nei')
...
def main2(i, flow_dict):
	...
	model2 = classification(args).cuda()
