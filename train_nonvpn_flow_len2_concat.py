...
from tool_nonvpn import traffics_nonvpn,load_epoch_data_flow_len,max_byte_len
...
parser.add_argument('--d_ff', type=int, default=2048, help='Hidden Size.')
...
parser.add_argument("--load_path", type=str, default='./results/nonvpn/session/lessdetail/session2pkts_60_500_42_256')
parser.add_argument("--save_path", type=str, default='./results/nonvpn/session/lessdetail/session2flows_len2_6_60_500_4222_256')
...
if __name__ == '__main__':
	...
	for i in range(1):
		with open('dataset/data_nonvpn/session/lessdetail/session2flows_len2_6_60_500/nonvpn_flow_6_60_500_%d.pkl'%i, 'rb') as f:
