...
from tool_app_total import traffics_app,load_epoch_data_flow,max_byte_len
...
parser.add_argument("--load_path", type=str, default='./results/app/session/lessdetail/session2pkts_len_50_42_256')
parser.add_argument("--save_path", type=str, default='./results/app/session/lessdetail/session2flows_len_3_50_4222_256')
...
def main2(i, flow_dict):
	...
	print(classification_report(test_label, pred, target_names=traffics_app ,digits=4))
...
if __name__ == '__main__':
	...
	for i in range(10):
		with open('./dataset/data_app_total/session/lessdetail/session2flows_len_3_50/total_flow_3_50_%d.pkl'%i, 'rb') as f:
