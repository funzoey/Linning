...
from tool_tor import traffics_tor,load_epoch_data_flow,max_byte_len
...
parser.add_argument("--load_path", type=str, default='./results/tor/session/lessdetail/session2pkts_len_50_5000_21_128')
parser.add_argument("--save_path", type=str, default='./results/tor/session/lessdetail/session2flows_len_3_50_5000_2122_128')
...
def main2(i, flow_dict):
	...
	print(classification_report(test_label, pred, target_names=traffics_tor ,digits=4))
...
if __name__ == '__main__':
	...
	for i in range(0,6):
		with open('./dataset/data_tor/session/lessdetail/flow/len/session2flows_len_3_50_5000/tor_flow_3_50_5000_%d.pkl'%i, 'rb') as f:
