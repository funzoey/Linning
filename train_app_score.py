...
parser.add_argument("--save_path", type=str, default='./results/app/session/lessdetail/score')
...
if __name__ == '__main__':
	...
	for i in range(1):
		with open('./dataset/data_app_total/session/lessdetail/session2pkts_len_50/total_pkt_50_%d.pkl'%i, 'rb') as f:
