...
from SAM import SAM
from tool_wide_flow_bytes import protocols, load_epoch_data, max_byte_len
...
def main(i, flow_dict):
	...
	optimizer = optim.Adam(filter(lambda x: x.requires_grad, model.parameters()),lr=0.0001)
	loss_list = []
	# default epoch is 3
...
if __name__ == '__main__':
	for i in range(10):
		with open('pcap_pro_flows_%d_noip_fold.pkl'%i, 'rb') as f:
