...
parser.add_argument("--save_path", type=str, default='./results/nonvpn/session/lessdetail/score')
...
def main(i, flow_dict):
	...
	# model.load_state_dict(torch.load('%s/model_%d.pth'%(args.save_path,i)))
