...
parser.add_argument("--load_path", type=str, default='./results/tor/session/lessdetail/pkts')
parser.add_argument("--save_path", type=str, default='./results/tor/session/lessdetail/flows')
...
if __name__ == '__main__':
	...
	for i in range(5,6):
		with open('./dataset/data_tor/session/lessdetail/session2flows_3_50_2500/tor_flow_3_50_2500_%d.pkl'%i, 'rb') as f:
