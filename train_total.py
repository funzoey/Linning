...
from tool_total import traffics_total,load_epoch_data,max_byte_len
...
parser.add_argument("--save_path", type=str, default='./results/total/session/session2pkts_len_50_42_256')
...
def main(i, flow_dict):
	...
	for epoch_i in trange(args.num_epochs, mininterval=2, \
		...
		"""
		with open('results_4000/atten_%d.txt'%i, 'w') as f2:
...
if __name__ == '__main__':
	...
	for i in range(4,5):
		with open('./dataset/data_total/session/pkts/len/session2pkts_len_50/total_pkt_50_%d.pkl'%i, 'rb') as f:
