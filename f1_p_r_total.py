...
from tool_total import traffics_total,load_epoch_data_flow,max_byte_len
...
parser.add_argument("--load_path", type=str, default='./results/total/session/session2pkts_len_50_42_256')
parser.add_argument("--save_path", type=str, default='./results/total/session/session2flows_len_3_50_4222_256')
...
def main2(i, flow_dict):
	...
	print(classification_report(test_label, pred, target_names=traffics_total ,digits=4))	
...
if __name__ == '__main__':
	...
	for i in range(5):
		with open('dataset/data_total/session/flows/len/session2flows_len_3_50/total_flow_3_50_%d.pkl'%i, 'rb') as f:
