...
parser.add_argument("--save_path", type=str, default='./results/nonvpn/session/lessdetail/session2pkts_len_60_500_42_256_pff')
...
if __name__ == '__main__':
	...
	for i in range(1):
		with open('dataset/data_nonvpn/session/lessdetail/session2pkts_len_60_500/nonvpn_pkt_60_500_%d.pkl'%i, 'rb') as f:
