...
from tool_vpn import traffics_vpn,load_epoch_data,max_byte_len
...
parser.add_argument("--save_path", type=str, default='./results/vpn/session/lessdetail/session2pkts_len_50_1000_82_256')
...
if __name__ == '__main__':
	...
	for i in range(8,10):
		with open('dataset/data_vpn/session/lessdetail/session2pkts_len_50_1000/vpn_pkt_50_1000_%d.pkl'%i, 'rb') as f:
